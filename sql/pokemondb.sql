...
CREATE TABLE `attaques` (
  ...
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`),
  CONSTRAINT `attaques_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `types` (`id`)
...
--
-- Table structure for table `detient_pokemons`
--

DROP TABLE IF EXISTS `detient_pokemons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `detient_pokemons` (
  ...
  KEY `dresseur_id` (`dresseur_id`),
  KEY `pokemon_id` (`pokemon_id`),
  CONSTRAINT `detient_pokemons_ibfk_1` FOREIGN KEY (`dresseur_id`) REFERENCES `dresseurs` (`id`),
  CONSTRAINT `detient_pokemons_ibfk_2` FOREIGN KEY (`pokemon_id`) REFERENCES `pokemons` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `detient_pokemons`
--

LOCK TABLES `detient_pokemons` WRITE;
/*!40000 ALTER TABLE `detient_pokemons` DISABLE KEYS */;
INSERT INTO `detient_pokemons` VALUES
(2,74,12),
(2,95,14),
(3,120,18),
(3,121,21),
...
(13,142,60),
(13,149,62);
/*!40000 ALTER TABLE `detient_pokemons` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `est_type`
--
...
CREATE TABLE `est_type` (
  ...
  KEY `pokemon_id` (`pokemon_id`),
  KEY `type_id` (`type_id`),
  CONSTRAINT `est_type_ibfk_1` FOREIGN KEY (`pokemon_id`) REFERENCES `pokemons` (`id`),
  CONSTRAINT `est_type_ibfk_2` FOREIGN KEY (`type_id`) REFERENCES `types` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `est_type`
--

LOCK TABLES `est_type` WRITE;
/*!40000 ALTER TABLE `est_type` DISABLE KEYS */;
INSERT INTO `est_type` VALUES
(1,9),
(1,10),
(2,9),
(2,10),
...
(150,11),
(151,11);
/*!40000 ALTER TABLE `est_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `evolue_en`
--
...
CREATE TABLE `evolue_en` (
  ...
  `niveau` int(11) NOT NULL,
  KEY `pokemon_base_id` (`pokemon_base_id`),
  KEY `pokemon_evol_id` (`pokemon_evol_id`),
  CONSTRAINT `evolue_en_ibfk_1` FOREIGN KEY (`pokemon_base_id`) REFERENCES `pokemons` (`id`),
  CONSTRAINT `evolue_en_ibfk_2` FOREIGN KEY (`pokemon_evol_id`) REFERENCES `pokemons` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `evolue_en`
--

LOCK TABLES `evolue_en` WRITE;
/*!40000 ALTER TABLE `evolue_en` DISABLE KEYS */;
INSERT INTO `evolue_en` VALUES
(1,2,16),
(2,3,32),
(4,5,16),
(5,6,36),
...
(147,148,30),
(148,149,55);
/*!40000 ALTER TABLE `evolue_en` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-02 17:18:48
